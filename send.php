<?php
    ...
    if(@$_POST['envio'] == 's') {
        ...
        try {
            ...
            $mail->SMTPAuth   = true;
            $mail->Username   = 'pruma@prumaarquitetura.com.br';
            $mail->Password   = 'Suplicy@2023';
            ...
            //Recipients
            $mail->setFrom('pruma@prumaarquitetura.com.br', 'www.prumaarquitetura.com.br');
            $mail->addAddress('pruma@prumaarquitetura.com.br', 'Pruma Arquitetura');
            $mail->addReplyTo('pruma@prumaarquitetura.com.br', 'Pruma Arquitetura');
